...
"[project]/audio-processor/app/api/stream/[jobId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    if (!job?.filePath || job.status !== 'completed') return __TURBOPACK__imported__module__$5b$project$5d2f$audio$2d$processor$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Audio not ready or expired.'
    }, {
        status: 404
    });
    try {
        const size = (await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["stat"])(job.filePath)).size;
        ...
        if (start > end || start >= size) return new __TURBOPACK__imported__module__$5b$project$5d2f$audio$2d$processor$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](null, {
            status: 416,
            headers: {
                'Content-Range': `bytes */${size}`
            }
        });
        const handle = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["open"])(job.filePath, 'r');
        const stream = handle.createReadStream({
            start,
            end
        });
        stream.once('close', ()=>void handle.close());
        return new __TURBOPACK__imported__module__$5b$project$5d2f$audio$2d$processor$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"].toWeb(stream), {
            status,
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b6qlq7._.js.map